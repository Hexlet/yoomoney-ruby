...
class Yoomoney::Test::PrimitiveModelTest < Minitest::Test
  A = Yoomoney::Internal::Type::ArrayOf[-> { Integer }]
  H = Yoomoney::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Yoomoney::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Yoomoney::Internal::Type::Unknown,
      Yoomoney::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Yoomoney::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Yoomoney::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Yoomoney::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Yoomoney::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Yoomoney::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Yoomoney::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Yoomoney::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Yoomoney::Internal::Type::Boolean, true] => true,
      [Yoomoney::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Yoomoney::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Yoomoney::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Yoomoney::Internal::Type::Converter.new_coerce_state
      Yoomoney::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Yoomoney::Internal::Type::Converter.dump(target, input, state: state)
...
class Yoomoney::Test::EnumModelTest < Minitest::Test
  class E0
    include Yoomoney::Internal::Type::Enum
...
class Yoomoney::Test::CollectionModelTest < Minitest::Test
  A1 = Yoomoney::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Yoomoney::Internal::Type::HashOf[Integer]

  A2 = Yoomoney::Internal::Type::ArrayOf[H1]
  H2 = Yoomoney::Internal::Type::HashOf[-> { A1 }]

  A3 = Yoomoney::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Yoomoney::Internal::Type::HashOf[Integer, nil?: true]
...
class Yoomoney::Test::BaseModelTest < Minitest::Test
  class M1 < Yoomoney::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Yoomoney::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Yoomoney::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Yoomoney::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Yoomoney::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Yoomoney::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Yoomoney::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Yoomoney::Errors::ConversionError => e
...
class Yoomoney::Test::UnionTest < Minitest::Test
  class U0
    include Yoomoney::Internal::Type::Union
  ...
  class M2 < Yoomoney::Internal::Type::BaseModel
  ...
  class M4 < Yoomoney::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Yoomoney::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Yoomoney::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Yoomoney::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Yoomoney::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Yoomoney::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Yoomoney::Internal::Type::Unknown, Yoomoney::Internal::Type::Unknown] => true,
      [Yoomoney::Internal::Type::Boolean, Yoomoney::Internal::Type::Boolean] => true,
      [Yoomoney::Internal::Type::Unknown, Yoomoney::Internal::Type::Boolean] => false,
...
class Yoomoney::Test::MetaInfoTest < Minitest::Test
  A1 = Yoomoney::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Yoomoney::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
