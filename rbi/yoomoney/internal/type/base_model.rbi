    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Yoomoney::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Yoomoney::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Yoomoney::Internal::Type::BaseModel::KnownField,
                  { type: Yoomoney::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Yoomoney::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Yoomoney::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Yoomoney::Internal::AnyHash) }
        def to_h
        end
