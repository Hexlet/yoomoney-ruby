    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Yoomoney::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Yoomoney::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Yoomoney::FilePart.new(value)
          in Yoomoney::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Yoomoney::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Yoomoney::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Yoomoney::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Yoomoney::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Yoomoney::Internal::Type::Converter
              ...
              Yoomoney::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Yoomoney::Internal::Type::Converter, T::Class[T.anything]) }
        end
